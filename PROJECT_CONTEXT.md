...
- Early first client reply buffering now also activates for the first ~45s after call start (even if mic activity wasn't detected) to avoid dropping the very first reply on slow connect/mic detection.
