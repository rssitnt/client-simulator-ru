...
- У чипов вариаций промпта кнопка удаления (`крестик`) сдвинута чуть правее за счёт более отрицательного `margin-right`, чтобы правый визуальный отступ был ближе к нижнему и чип выглядел аккуратнее.
- Версия CSS-кэша обновлена до `style.css?v=20260325-18`.
