...
- Для voice dropdown дополнительно зафиксирован scrollbar: меню теперь клипается по радиусу, использует thin scrollbar и не показывает вылезшие углы/кнопки у нативного Windows scroll.
